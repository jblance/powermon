""" tests / unit / test_format_simple.py """
import unittest
...
class TestFormatsSimple(unittest.TestCase):
    """ test the simple output formatter """
    def test_simple_format_no_extra(self):
        """ test simple format without any extra info """
    ...
    def test_simple_format_with_device_class(self):
        """ test simple format with a device class extra info """
    ...
    def test_simple_format_with_icon(self):
        """ test simple format with an icon extra info """
    ...
    def test_simple_format_with_all_extra(self):
        """ test simple format with device and state classes and icon extra info """
    ...
    def test_simple_format_multiple(self):
        """ test simple format with 2 readings """
        expected = ["test=230Wh",
                    "test2=28.0°C"]
        simple_formatter = SimpleFormat({})
