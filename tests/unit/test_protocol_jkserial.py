...
from powermon.exceptions import InvalidResponse, PowermonProtocolError
...
class TestProtocolJKSerial(unittest.TestCase):
    ...
    def test_check_crc(self):
        ...
        result = proto.check_crc(response=b"\x00\x1a:70010007800C6\n", command_definition=proto.get_command_definition('battery_voltage'))
    ...
    def test_check_valid(self):
        ...
        result = proto.check_valid(response=response, command_definition=proto.get_command_definition('battery_voltage'))
        # print(result)
        self.assertTrue(result)
    ...
    def test_check_valid_short(self):
        ...
        response = b'NW'
        self.assertRaises(InvalidResponse, proto.check_valid, response=response, command_definition=proto.get_command_definition('battery_voltage'))
    ...
    def test_port_supported_serial(self):
        ...
        _port = SerialPort("/dev/tty0", 9600, proto)
    ...
    def test_port_notsupported_usb(self):
        ...
        self.assertRaises(PowermonProtocolError, USBPort, "path", proto)
    ...
    def test_get_full_command_battery_voltage(self):
        ...
        result = proto.get_full_command(command="battery_voltage")
