...
class TestProtocolPi30Max(unittest.TestCase):
    """ exercise different functions in PI30 MAX protocol """
    ...
    def test_build_result_verfw(self):
        ...
        expected = ['bluetooth_firmware_version=00072.70']
        simple_formatter = SimpleFormat({"extra_info": False})
        device_info = DeviceInfo(name="name", serial_number="serial_number", model="model", manufacturer="manufacturer")
    ...
    def test_build_result_qoppt(self):
        ...
        expected = ['output_source_priority_00_hours=Solar > Battery > Utility', 'output_source_priority_01_hours=Solar > Battery > Utility', 'output_source_priority_02_hours=Solar > Battery > Utility', 'output_source_priority_03_hours=Solar > Battery > Utility', 'output_source_priority_04_hours=Solar > Battery > Utility', 'output_source_priority_05_hours=Solar > Battery > Utility', 'output_source_priority_06_hours=Solar > Battery > Utility', 'output_source_priority_07_hours=Solar > Battery > Utility', 'output_source_priority_08_hours=Solar > Battery > Utility', 'output_source_priority_09_hours=Solar > Battery > Utility', 'output_source_priority_10_hours=Solar > Battery > Utility', 'output_source_priority_11_hours=Solar > Battery > Utility', 'output_source_priority_12_hours=Solar > Battery > Utility', 'output_source_priority_13_hours=Solar > Battery > Utility', 'output_source_priority_14_hours=Solar > Battery > Utility', 'output_source_priority_15_hours=Solar > Battery > Utility', 'output_source_priority_16_hours=Solar > Battery > Utility', 'output_source_priority_17_hours=Solar > Battery > Utility', 'output_source_priority_18_hours=Solar > Battery > Utility', 'output_source_priority_19_hours=Solar > Battery > Utility', 'output_source_priority_20_hours=Solar > Battery > Utility', 'output_source_priority_21_hours=Solar > Battery > Utility', 'output_source_priority_22_hours=Solar > Battery > Utility', 'output_source_priority_23_hours=Solar > Battery > Utility', 'device_output_source_priority=Solar > Battery > Utility', 'selection_of_output_source_priority_order_1=Utility > Solar > Battery', 'selection_of_output_source_priority_order_2=Solar > Battery > Utility', 'selection_of_output_source_priority_order_3=Solar > Utility > Battery']
        simple_formatter = SimpleFormat({"extra_info": False})
        device_info = DeviceInfo(name="name", serial_number="serial_number", model="model", manufacturer="manufacturer")
    ...
    def test_build_result_qchpt(self):
        ...
        expected = ['charger_source_priority_00_hours=Solar only', 'charger_source_priority_01_hours=Solar only', 'charger_source_priority_02_hours=Solar only', 'charger_source_priority_03_hours=Solar only', 'charger_source_priority_04_hours=Solar only', 'charger_source_priority_05_hours=Solar only', 'charger_source_priority_06_hours=Solar only', 'charger_source_priority_07_hours=Solar only', 'charger_source_priority_08_hours=Solar only', 'charger_source_priority_09_hours=Solar only', 'charger_source_priority_10_hours=Solar only', 'charger_source_priority_11_hours=Solar only', 'charger_source_priority_12_hours=Solar only', 'charger_source_priority_13_hours=Solar only', 'charger_source_priority_14_hours=Solar only', 'charger_source_priority_15_hours=Solar only', 'charger_source_priority_16_hours=Solar only', 'charger_source_priority_17_hours=Solar only', 'charger_source_priority_18_hours=Solar only', 'charger_source_priority_19_hours=Solar only', 'charger_source_priority_20_hours=Solar only', 'charger_source_priority_21_hours=Solar only', 'charger_source_priority_22_hours=Solar only', 'charger_source_priority_23_hours=Solar only', 'device_charger_source_priority=Solar only', 'selection_of_charger_source_priority_order_1=Utility first', 'selection_of_charger_source_priority_order_2=Utility first', 'selection_of_charger_source_priority_order_3=Utility first']
        simple_formatter = SimpleFormat({"extra_info": False})
        device_info = DeviceInfo(name="name", serial_number="serial_number", model="model", manufacturer="manufacturer")
