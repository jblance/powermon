...
QUERY_COMMANDS = {
    ...
    "EY": {
        ...
        "reading_definitions": [
            ...
            {"description": "Year",
                ...
                "response_type": ResponseType.INFO_FROM_COMMAND,
                "format_template": "int(cn[3:])"
            },
        ],
        "test_responses": [
    ...
    "EM": {
        ...
        "reading_definitions": [
            ...
            {"description": "Year",
                "reading_type": ReadingType.YEAR,
                "response_type": ResponseType.INFO_FROM_COMMAND,
                "format_template": "int(cn[3:7])",
            },
            {"description": "Month",
                "reading_type": ReadingType.MONTH,
                "response_type": ResponseType.INFO_FROM_COMMAND,
                "format_template": "calendar.month_name[int(cn[7:])]",
            },
        ],
        "test_responses": [
            b"",
    ...
    "ED": {
        ...
        "reading_definitions": [
            ...
            {"description": "Month",
                "reading_type": ReadingType.MONTH,
                "response_type": ResponseType.INFO_FROM_COMMAND,
                "format_template": "calendar.month_name[int(cn[7:9])]"
            },
            {"description": "Day",
                "reading_type": ReadingType.DAY,
                "response_type": ResponseType.INFO_FROM_COMMAND,
                "format_template": "int(cn[9:11])"
            },
        ],
        "test_responses": [
            b"(00238800!J\r",
    ...
    "PIRI": {
        ...
        "reading_definitions": [
            {"description": "AC Input Voltage",
                ...
                "response_type": ResponseType.TEMPLATE_INT,
                "format_template": "r/10"
            },
            ...
            {"description": "AC Output Frequency",
                "reading_type": ReadingType.FREQUENCY,
                "response_type": ResponseType.TEMPLATE_INT,
                "format_template": "r/10"
            },
            ...
            {"description": "AC Output Apparent Power",
                 "reading_type": ReadingType.APPARENT_POWER
            },
            {"description": "AC Output Active Power",
                 "reading_type": ReadingType.WATTS
            },
            ...
            {"description": "Battery Bulk Charge Voltage",
                 "reading_type": ReadingType.VOLTS,
                 "response_type": ResponseType.TEMPLATE_INT,
                 "format_template": "r/10"
            },
            {"description": "Battery Float Charge Voltage",
                 "reading_type": ReadingType.VOLTS,
                 "response_type": ResponseType.TEMPLATE_INT,
                 "format_template": "r/10"
            },
    ...
    "GS": {
		...
		"icon": "mdi:power-plug",
            ...
            {"description": "Battery Voltage from SCC2",
                "reading_type": ReadingType.VOLTS,
                "response_type": ResponseType.TEMPLATE_INT,
                "format_template": "r/10",
                "icon": "mdi:battery-outline",
            ...
            {"description": "MPPT1 charger temperature",
                "reading_type": ReadingType.TEMPERATURE,
                "response_type": ResponseType.INT,
                "icon": "mdi:details",
                "device_class": "temperature",
            },
            {"description": "MPPT2 charger temperature",
                "reading_type": ReadingType.TEMPERATURE,
                "response_type": ResponseType.INT,
                "icon": "mdi:details",
                "device_class": "temperature",
            },
            {"description": "MPPT1 Input Power",
                "reading_type": ReadingType.WATTS,
                "response_type": ResponseType.INT,
                "icon": "mdi:solar-power",
                "device_class": "power",
            ...
            {"description": "MPPT1 Input Voltage",
                "reading_type": ReadingType.VOLTS,
                "response_type": ResponseType.TEMPLATE_INT,
                "format_template": "r/10",
                "icon": "mdi:solar-power",
            ...
            {"description": "MPPT2 Input Voltage",
                "reading_type": ReadingType.VOLTS,
                "response_type": ResponseType.TEMPLATE_INT,
                "format_template": "r/10",
                "icon": "mdi:solar-power",
            ...
            {"description": "Setting value configuration state",
                "reading_type": ReadingType.MESSAGE,
            ...
            {"description": "MPPT1 charger status",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.OPTION,
                "options": {
                    "0": "abnormal",
            ...
            {"description": "MPPT2 charger status",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.OPTION,
                "options": {
                    "0": "abnormal",
            ...
            {"description": "Battery power direction",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.OPTION,
                "options": {
                    "0": "donothing",
            ...
            {"description": "DC/AC power direction",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.OPTION,
                "options": {
                    "0": "donothing",
            ...
            {"description": "Parallel instance number",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.LIST,
